...
class TestBoardMethods(unittest.TestCase):
    ...
    def test_room_to_room(self):
        assert self.board.room_to_room(5, 7) == False
    ...
    def test_many_steps(self):
        assert self.board.pop_to_hall(7, 4) == 40
        assert self.board.room_to_room(5, 7) == 400
        assert self.board.pop_to_hall(5, 6) == 3000
        assert self.board.push_from_hall(4, 5) == 30
        assert self.board.room_to_room(3, 5) == 40
